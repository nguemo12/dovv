...
<h2>Modifier un Produit</h2>
        ...
        <div class="form-group">    
            <span>#ID product</span> <input type="text" name="id" placeholder="ex:1" class="form-control" required>
            </div>
            <div class="form-group">    
        ...
        <div class="form-group">    
         ...
         <div class="form-group">    
           ...
           <br>
                <input type="submit" name="save" class="btn btn-success" value="Ajouter le produit" required>
        </div>
            </div> 
</form>
</body>
