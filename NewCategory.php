...
<div class="row">
        ...
        <div class="col-lg-4">
            ...
            <span>Ajouter une Category</span> <input type="text" name="login" placeholder="ex:mboyo" class="form-control" required>
            </div>
        </div>
         <div class="col-lg-4">
        <input type="submit" name="save" class="btn btn-success" value="Ajouter" required>
                        ...
                        <h3 class="fs-4 mb-3">Liste des Category</h3>
                            <thead>
                                <tr>
