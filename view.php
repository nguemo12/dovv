            ...
            <div class="panel info-box panel-white">
                    <div class="panel-body">
                        ...
                        if (isset($_GET['view'])) {
                            ...
                            $result = $mysqli->query("select * from product where product_id=$id") or die(mysqli_error($mysqli));
                        ...
                        ?>
                            <div class="row">
                                <div class="col-lg-3">
                                 ...
                                 <img src="<?php echo $data['product_image']?>" width="150px"  height="150px"><br>
                                </div>
                                ...
                                <div class="stats">
                        <?php
                                echo "<strong>". $data['product_name']. "</strong><br><br>";
                                ...
                                echo "Prix unique:".$data['unit_price']."<br><br>";
                        
                                echo "description: " . $data['product_description'] . "<br><br>";
                      
                                echo "quantity: " .  $data['quantity'] . "<br><br>";
